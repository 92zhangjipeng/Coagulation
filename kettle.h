...
#define TEXT_POS_SHOW_Y  25
class Kettle : public QWidget
{
    Q_OBJECT
...
public:
    explicit Kettle(QWidget *parent = nullptr);
    ~Kettle();

    void _setreagname(QString reagname);
protected:
...
private:
    void _replacereag(int x_,int y_);
