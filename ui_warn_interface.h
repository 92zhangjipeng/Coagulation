...
public:
    ...
    void setupUi(QWidget *warn_interface)
    {
        ...
        warn_interface->resize(350, 201);
        warn_interface->setStyleSheet(QStringLiteral("background-color: qlineargradient(spread:pad, x1:0.500273, y1:0.438, x2:0.500727, y2:0.909, stop:0 rgba(190, 154, 124, 255), stop:0.971591 rgba(96, 71, 62, 255));"));
        verticalLayout = new QVBoxLayout(warn_interface);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        widget_title = new QWidget(warn_interface);
...
"}"));
        ...
        widget_wram = new QWidget(warn_interface);
        widget_wram->setObjectName(QStringLiteral("widget_wram"));
        widget_wram->setStyleSheet(QLatin1String("background-color: rgba(188,187,183);\n"
"border-top-color: rgb(0, 0, 0);\n"
"border: opx solid rgba(198,197,193);"));
        verticalLayout_2 = new QVBoxLayout(widget_wram);
...
"border-style: flat;background: transparent;"));
        ...
        verticalLayout_2->addWidget(label_warmtext);

        toolButton = new QToolButton(widget_wram);
...
""));
    ...
    {
        warn_interface->setWindowTitle(QApplication::translate("warn_interface", "Form", nullptr));
        label_icon->setText(QString());
        label_name->setText(QApplication::translate("warn_interface", "TextLabel", nullptr));
        toolButton_min->setText(QString());
        toolButton_max->setText(QString());
        toolButton_close->setText(QString());
        label_warmtext->setText(QApplication::translate("warn_interface", "\346\217\220\347\244\272", nullptr));
        toolButton->setText(QApplication::translate("warn_interface", "\347\241\256   \345\256\232", nullptr));
    } // retranslateUi
