...
private:
    ...
    //内部边框类，防止外部创建
    class MyLableBorder: public QLabel
    {
        public:
            //设置边框属性
            MyLableBorder(QWidget *parent, BorderType type, MyBorderContainer * outClass);
        protected:
    ...
    //边框控件
    MyLableBorder *labelLft;
    MyLableBorder *labelRit;
    MyLableBorder *labelBot;
    MyLableBorder *labelTop;
    MyLableBorder *labelRB;
    MyLableBorder *labelRT;
    MyLableBorder *labelLB;
    MyLableBorder *labelLT;
};
