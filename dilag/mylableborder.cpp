...
MyBorderContainer::MyLableBorder::MyLableBorder(QWidget *parent, BorderType type, MyBorderContainer * contex)
{
...
//鼠标点击事件
void MyBorderContainer::MyLableBorder::mousePressEvent(QMouseEvent *ev)
{
    if(ev->button() == Qt::LeftButton)
    {
        KeepDrag = true;
        mousePointOld = ev->globalPos();
        QLOG_DEBUG()<<"btn"<<mousePointOld<<__FUNCTION__<<endl;
    }
    return QWidget::mousePressEvent(ev);
}

//鼠标移动事件
void MyBorderContainer::MyLableBorder::mouseMoveEvent(QMouseEvent *ev)
{
   if(KeepDrag)
   {
       ...
       mousePointOld = ev->globalPos();
       QLOG_DEBUG()<<"btnmove"<<mousePointOld<<endl;
   }
   return QWidget::mouseMoveEvent(ev);
}

//鼠标释放事件
void MyBorderContainer::MyLableBorder::mouseReleaseEvent(QMouseEvent *ev)
{
    Q_UNUSED(ev)
    KeepDrag = false;
    QLOG_DEBUG()<<"btnres"<<mousePointOld<<__FUNCTION__<<endl;
