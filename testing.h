...
// 血样孔类型定义
constexpr int BLOOD_HOLE_TYPE_EVEN = 0; // 偶数孔为血样孔
constexpr int BLOOD_HOLE_TYPE_ODD = 1;   // 奇数孔为富血样孔
...
public:
    ...
    QList<quint8> getAllocatePPPandPRPHole();
...
private:
    ...
    QList<quint8> mreminderPPPandPRPhole; //提示要放置的血样孔号
